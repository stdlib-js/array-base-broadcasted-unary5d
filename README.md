...
```javascript
bunary5d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-base-broadcasted-unary5d@v0.2.2-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/array-base-broadcasted-unary5d@v0.2.2-umd/browser.js"></script>
```
