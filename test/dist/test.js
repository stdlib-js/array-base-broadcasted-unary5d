...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof bunary5d, 'function', 'main export is a function' );
	t.end();
});

tape( 'the function applies a provided callback to a broadcasted input array and assigns results to a nested output array', function test( t ) { // eslint-disable-line max-lines-per-function
	var expected;
	var shapes;
	var x;
	var y;
